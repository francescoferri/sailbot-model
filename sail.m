function [sail_thrust_force,sail_heeling_torque,sail_heeling_force_wind,sail_angle] = sail(rho_air, mu_air, M, W_speed, W_app_angle, S_area, S_avg_ch, S_alpha, S_span, S_mass, H_heel)
